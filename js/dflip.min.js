...
// Log pdfMinUrl and pdfWorkerUrl before loading them
console.log('pdfMinUrl:', pdfMinUrl);
console.log('pdfWorkerUrl:', pdfWorkerUrl);

// Ensure locationVar is defined if not found
var locationVar = window.location || {
    href: '',
    pathname: '/',
    search: '',
    hash: ''
...
// Ensure locationVar is defined if not found
if (typeof locationVar === 'undefined') {
    var locationVar = window.location || {
        href: '',
        pathname: '/',
        search: '',
...
!function () {
    ...
    function () {
        ...
        e._defaults = {
            ...
            soundFile: "https://cdn.jsdelivr.net/gh/Paulenski205/shopify-dflip-accessories@main/sound/turn2.mp3",
imagesLocation: "https://cdn.jsdelivr.net/gh/Paulenski205/shopify-dflip-accessories@main/images/",
    imageResourcesPath: "https://cdn.jsdelivr.net/gh/Paulenski205/shopify-dflip-accessories@main/images/pdfjs/",
            popupThumbPlaceholder: "data:image/svg+xml," + escape('<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 297"><rect width="210" height="297" style="fill:#f1f2f2"/><circle cx="143" cy="95" r="12" style="fill:#e3e8ed"/><polygon points="131 138 120 149 95 124 34 184 176 185 131 138" style="fill:#e3e8ed"/></svg>'),
            cMapUrl: "https://cdn.jsdelivr.net/gh/Paulenski205/shopify-dflip-accessories@main/cmaps/",
pdfjsSrc: "//summerlandsales.com/cdn/shop/t/14/assets/pdf.min.js",
threejsSrc: "//summerlandsales.com/cdn/shop/t/14/assets/three.min.js",
            logo: "",
            logoUrl: "",
            sharePrefix: "",
        ...
        u = a.utils = {
            ...
            getScript: function (e, t, i, n) {
                ...
                if (0 === r("script[src='" + e + "']").length) {
                    ...
                    null != p ? (p.parentNode.insertBefore(o, p), p = null) : document.body.appendChild(o),
            ...
            canSupport3D: function () {
                ...
                try {
                    if (0 == u.hasWebgl)
                        e = !1, console.log("Proper Support for Canvas webgl 3D not detected!");
                    else if (0 == u.hasES2022)
                        e = !1, console.log("Proper Support for 3D not extpected in older browser!");
                        ...
                        e = !1, console.log("Proper Support for 3D not detected for Safari!");
                    else {
                    ...
                    if (i && i.indexOf(t) >= 0 && !1 === e.hashFocusBookFound) {
                        ...
                        if (n.length > 0) {
                            ...
                            if (null != a && (a = a.split("/")[0]), 0 === (o = r("[data-df-slug=" + n + "]")).length && (o = r("[data-slug=" + n + "]")), 0 === o.length && (o = r("#df-" + n + ",#" + n)), 0 === o.length && (o = r("[data-_slug=" + n + "]")), o.length > 0 && o.is("._df_thumb,._df_button,._df_custom,._df_link,._df_book,.df-element,.dp-element")) {
                                ...
                                if (null != s)
                                    return s.gotoPage(a), s.hashNavigationEnabled = !0, u.focusHash(s.element), !1;
        ...
        u.getOptions = function (e) {
            ...
            n = void 0;
            n = "object" === t(i) ? i : null == i || "" === i || null == window[i] ? {}
             : window[i];
            var o = function (e) {
                var t = {},
                i = {
        ...
        e.parseCSSElements = function () {
            r(".dvcss").each((function () {
                    ...
                    if (e) {
                        ...
                        "none" !== e.lightbox && (t.attr("data-df-lightbox", void 0 === e.lightbox ? "custom" : e.lightbox), "thumb" == e.lightbox && t.attr("data-df-thumb", e.pdfThumb), e.thumbLayout && t.attr("data-df-thumb-layout", e.thumbLayout), e.apl && t.attr("apl", e.apl)),
                        t.data("df-option", n),
        ...
        e.parseThumbs = function (t) {
            t.element.html(""),
            null != t.thumbURL && "" != t.thumbURL.toString().trim() || (t.element.addClass("df-thumb-not-found"), t.thumbURL = e.defaults.popupThumbPlaceholder);
            ...
            "book-title-top" === t.thumbLayout ? i.prependTo(t.element) : "book-title-bottom" !== t.thumbLayout && "cover-title" !== t.thumbLayout || (t.hasShelf ? t.thumbLayout = "book-title-fixed" : i.appendTo(t.element), !0 === e.defaults.displayLightboxPlayIcon && (t.element.removeClass("df-icon-play-popup"), n.addClass("df-icon-play-popup"))),
        ...
        e.parseNormalElements = function () {
            ...
            e.handleLazy = function () {
                ...
                if (t = e.embeds.shift()) {
                    ...
                    if (o.length > 0)
                        if (o.is("img"))
                            o.hasClass("df-lazy") ? (o.attr("src", o.attr("data-src")), o.removeAttr("data-src"), o.removeClass("df-lazy"), e.lazyObserver.unobserve(o[0]), e.handleLazy()) : (u.log("Prevent this"), e.handleLazy());
                        else {
                            var a = o.data("df-app");
        ...
        "function" == typeof IntersectionObserver && (e.lazyObserver = new IntersectionObserver((function (t, i) {
                        t.forEach((function (t) {
                                ...
                                n = r(t.target),
                                o = n.attr("initID");
                                t.isIntersecting ? (n.attr("initID") || (n.attr("initID", e.initId), o = e.initId.toString(), e.initId++), (i = e.removeEmbeds.indexOf(o)) > -1 ? (e.removeEmbeds.splice(i, 1), u.log("Removed id " + o + "from Removal list")) : -1 == (i = e.embeds.indexOf(o)) && (e.embeds.push(o), u.log("Added id " + o + "to Add list"))) : o && ((i = e.embeds.indexOf(o)) > -1 ? (e.embeds.splice(i, 1), u.log("Removed id " + o + " from Add list")) : -1 == (i = e.removeEmbeds.indexOf(o)) && (e.removeEmbeds.push(o), u.log("Added id " + o + " to Removal list"))),
                                d = 0,
        ...
        function g(e, t) {
            for (var i = 0; i < t.length; i++) {
                ...
                Object.defineProperty(e, (o = n.key, a = void 0, a = function (e, t) {
            ...
            n = [{
                    ...
                    value: function (t, i) {
                        ...
                        if (u = r === e.TEXTURE_TARGET.THUMB ? n.thumbSize : Math.floor(l.height), void 0 === o.getCache(a, u)) {
                            ...
                            return d > .001 && d < 2 && (p.width = Math.floor(l.width), p.height = Math.floor(l.height)),
                    ...
                    value: function (e) {
                        ...
                        this.startPoint && 1 != this.pinchZoomDirty && (this.pan(this.eventToPoint(e)), e.preventDefault())
                    }
                }, {
                    key: "mouseDown",
                    value: function (e) {
                    ...
                    value: function () {
                        ...
                        this.panRequestStatus === t.ON && (this.updatePan(), this.panRequestStatus = t.OFF),
                        this.app.viewer.pinchZoomRequestStatus === t.ON && (this.app.viewer.updateTemporaryScale(), this.app.viewer.pinchZoomRequestStatus = t.OFF)
                    }
                }, {
                    key: "isAnimating",
                    value: function () {
                    ...
                    value: function (e) {
                        ...
                        if (void 0 !== i)
                            return void 0 === i.annotationElement && (i.annotationElement = jQuery("<div class='df-link-content'>"), i.contentLayer.append(i.annotationElement)), !0 === t && i.annotationElement.html(""), i.annotationElement[0]
                    }
                }, {
                    key: "getTextElement",
                    value: function (e) {
                        ...
                        i = this.getPageByNumber(e);
                        if (void 0 !== i)
                            return void 0 === i.textElement && (i.textElement = jQuery("<div class='df-text-content'>"), i.contentLayer.append(i.textElement)), !0 === t && (i.textElement.html(""), i.textElement.siblings(".df-auto-link-content").html("")), i.textElement[0]
                    }
                }, {
                    key: "render",
                    value: function () {}
        ...
        O = function (e) {
            ...
            return x(i, [{
                        ...
                        value: function (e) {
                            ...
                            !0 === t.canvasMode ? (t.element.find(">canvas").remove(), i !== t.textureLoadFallback && (t.textureSrc = i, t.element.append(jQuery(i))), t.updateTextureLoadStatus(!0), "function" == typeof n && n(e)) : i === t.textureLoadFallback ? o() : (t.texture.onload = o, t.texture.src = i)
                        }
                    }, {
                        key: "updateCSS",
                        value: function (e) {
            ...
            n = [{
                    ...
                    value: function (e) {
                        if ("-1" !== e.textureStamp && void 0 !== e.pageNumber) {
                            ...
                            this.pageBuffer.length > this.pageBufferSize && (D.log("Farthest buffer: " + i), this.pageBuffer[n].reset(), this.pageBuffer.splice(n, 1))
                        }
                    }
                }, {
                    key: "initCustomControls",
                    ...
                    value: function () {
                        ...
                        t = this.maxZoom = 4,
                        i = e.zoomValue;
                        !0 === e.pendingZoom && null != e.zoomDelta ? i = e.zoomDelta > 0 ? i * e.options.zoomRatio : i / e.options.zoomRatio : null != this.lastScale && (i *= this.lastScale, this.lastScale = null),
                    ...
                    value: function () {
                        for (var t = this, i = this.app, n = t.getVisiblePages().main, o = 0; o < n.length; o++) {
                            var a = void 0,
                            r = n[o];
                            r !== (a = t.pages[r - 1]).pageNumber && (a.resetTexture(), this.app.textureRequestStatus = e.REQUEST_STATUS.ON),
                    ...
                    value: function (e) {
                        ...
                        e.srcElement === this.scrollBar[0] && (this.isScrollBarPressed = !0, this.scrollBar.addClass("df-active"), this.scrollPageNumber.addClass("df-active"))
                    }
                }, {
                    key: "mouseUp",
                    value: function (e) {
                        N(M(r.prototype), "mouseUp", this).call(this, e),
                        (this.isScrollBarPressed = this.scrollBar) && (this.isScrollBarPressed = !1, this.scrollBar.removeClass("df-active"), this.scrollPageNumber.removeClass("df-active"))
                    }
                }
            ],
            n && L(i.prototype, n),
            ...
            return U(n, [{
                        ...
                        value: function (e, t) {
                            ...
                            if (!0 !== i.pinchZoomDirty && 1 === i.app.zoomValue && !0 === i.canSwipe) {
                                ...
                                Math.abs(n) > i.swipeThreshold && (n < 0 ? i.app.openRight() : i.app.openLeft(), i.canSwipe = !1, t.preventDefault()),
                                i.lastPosX = e.x,
                                i.lastPosY = e.y
                            }
                        }
                        ...
                        value: function () {
                            ...
                            n.centerNeedsUpdate && (n.centerShift = t, n.updateCenter(i), n.centerNeedsUpdate = !1)
                        }
                    }, {
                        key: "updateCenter",
                        value: function () {
                        ...
                        value: function () {
                            for (var e, t = 0; t < this.sheets.length; t++)
                                (e = this.sheets[t]).reset(), e.pageNumber = -1, e.frontPage && (e.frontPage.pageNumber = -1), e.backPage && (e.backPage.pageNumber = -1), e.resetTexture();
                        ...
                        value: function () {
                            ...
                            !(e.zoomChanged = e.zoomValue !== o) || 1 !== o && 1 !== e.zoomValue || (a = 1 === o, r = 1 === e.zoomValue),
                            e.zoomValue = o,
                            (r || a) && (e.container.toggleClass("df-zoom-active", 1 !== o), r && this.enterZoom(), a && this.exitZoom())
                        }
                    }, {
                        key: "refresh",
                        value: function () {
                            ...
                            p = Math.floor(n / 2);
                            r !== t.oldBasePageNumber && (t.pageNumberChanged = !0, this.updatePendingStatusClass(!0), t.zoomViewer.reset()),
                            ...
                            for (l = 0; l < n; l++) {
                                ...
                                if (o && (f = h - f - 1), null != (d = t.sheets[l])) {
                                    ...
                                    if (!g && v && d.isFlipping && d.currentTween && d.currentTween.stop(), d.isHard = t.isSheetHard(f), d.isCover = t.isSheetCover(f), v)
                                        d.resetTexture(), (this.app.isRTL ? d.backPage : d.frontPage).pageNumber = this.isBooklet ? f : 2 * f + 1, (this.app.isRTL ? d.frontPage : d.backPage).pageNumber = this.isBooklet ? -1 : 2 * f + 2, i.textureRequestStatus = e.REQUEST_STATUS.ON;
                                    d.pageNumber = f,
                                    t.refreshSheet({
                                        sheet: d,
                                        sheetNumber: f,
                        ...
                        value: function (e) {
                            ...
                            o = void 0;
                            return (o = this.app.zoomValue > 1 || !0 === i ? this.zoomViewer.getAnnotationElement(e, t) : j(q(n.prototype), "getAnnotationElement", this).call(this, e, t)) && (o.parentNode.classList.toggle("df-double-internal", this.isDoubleInternalPage(e)), o.parentNode.classList.toggle("df-double-internal-fix", this.isDoublePageFix(e))),
                            o
                        }
                    }, {
                        key: "getTextElement",
                            ...
                            if (t = t || i.pendingPoint, null != i && null != i.viewer) {
                                ...
                                !0 === i.isHard ? (null != t && (h = se.angleByDistance(t.distance, t.fullWidth)), n = i.init = {
                                 ...
                                 : (n = i.init = {
                                        ...
                                        y: t.y,
                                        opacity: 1
                                    }, p = i.viewer.app.options.duration * se.distPoints(n.x, n.y, o.x, o.y) / i.viewer.fullWidth, p = se.limitAt(p, i.viewer.app.options.duration / 3, i.viewer.duration)),
                                n.index = 0,
                                o.index = 1,
                                i.isFlipping = !0,
        ...
        ue = function (t) {
            ...
            return te(n, [{
                        ...
                        value: function (e) {
                            ...
                            t.visible = e.visible,
                            t.isHard ? t.element.addClass("df-hard-sheet") : (t.element.removeClass("df-hard-sheet"), t.frontPage.updateCSS({
                                    display: "block"
                        ...
                        value: function (e) {
                            ...
                            if (null == e.touches || 2 != e.touches.length) {
                                ...
                                null == t.dragSheet && null != n && !1 === i.isInsideCorner && !0 === n.magnetic && (n.pendingPoint = i, n.animateToReset = !0, n.magnetic = !1, t.corner = n.magneticCorner, n.flip(n.pendingPoint), n.pendingPoint = null),
                                t.checkSwipe(i, e)
                            } else
                                this.pinchMove(e)
                        }
                            ...
                            if (null != i.startPoint && (t.touches || 0 === t.button))
                                if (null != i.dragSheet || null == t.touches || 0 != t.touches.length) {
                                    ...
                                    if (!0 === t.ctrlKey && a)
                                        ...
                                        t.preventDefault();
                                        var r = i.dragSheet;
                                        if (r.pendingPoint = n, i.drag = n.drag, a && (!0 === n.isInsideCorner || n.isInsideSheet && i.clickAction === re.MOUSE_CLICK_ACTIONS.NAV))
                                            ...
                                            s === this.getBasePage() && (r.animateToReset = !0, r.flip(n))
                                        }
                                        i.dragSheet = null,
                                        r.magnetic = !1
                                    } else
                        ...
                        value: function (e) {
                            if (e.touches || 0 === e.button)
                                if (null == e.touches || 2 != e.touches.length) {
                                    ...
                                    t.lastPosX = i.x,
                                    t.lastPosY = i.y,
                                    i.isInsideCorner && null == t.flipPage ? (t.dragSheet = i.sheet, t.drag = i.drag, t.corner = i.corner, 0 === i.sheet.pageNumber ? t.bookShadow.css({
                                            width: "50%",
        ...
        Pe = function (t) {
            ...
            return fe(n, [{
                        ...
                        value: function (t) {
                            ...
                            !1 === i.isFlipping && (t.needsFlip ? i.flip() : (i.skipFlip = !1, i.element.removeClass("df-flipping df-quick-turn df-folding df-left-side df-right-side"), i.element.addClass(i.targetSide === e.TURN_DIRECTION.LEFT ? "df-left-side" : "df-right-side"), i.side = i.targetSide)),
                            i.visible = t.visible,
                            i.updateCSS({
                        ...
                        value: function () {
                            if (!this.isFlipping()) {
                                for (var e = 0, t = 0, i = this.app, n = (Math.floor(this.stackCount / 2), []), o = i.currentPageNumber, a = 0; a < this.stackCount / 2; a++)
                                ...
                                for (var r = 0; r < this.stackCount; r++) {
                                    ...
                                    if (this.getPageByNumber(s)) {
                                        ...
                                        i.currentPageNumber > l.pageNumber ? (e -= Math.floor(h.width) + 10, l.positionX = e) : (l.positionX = t, t += Math.floor(h.width) + 10);
        ...
        Ae = function (e) {
            ...
            return ke(i, [{
                        ...
                        value: function () {
                            ...
                            if (void 0 !== this.viewer && null !== this.viewer) {
                                ...
                                if (void 0 !== k.attributes) {
                                    ...
                                    for (var M = 0; M < 1; M++)
                                        for (var D = 1; D < n; D++)
                                            I[A].z = I[A + 3 * _].z = h[0][D].z, I[A].x = I[A + 3 * _].x = h[0][D].x, I[A + _].z = I[A + 2 * _].z = u[0][D].z, I[A + _].x = I[A + 2 * _].x = u[0][D].x, A++;
                        ...
                        value: function (e, t) {
                            ...
                            i.isFlipping = !0;
                            n && (!a && !r || a && r) && (i.element.material[5].opacity = i.element.material[4].opacity = 0, i.element.castShadow = !1),
                            i.currentTween = new TWEEN.Tween(i.init).to({
                                ...
                                width: i.end.width
                                        ...
                                        !function (e) {
                                            ...
                                            !0 === i.isHard ? (i.flexibility = 0, i.isCover && i.viewer.flipCover(i)) : i.flexibility = e.angle < 90 ? i.leftFlexibility : i.rightFlexibility,
                                            i.element.position.z = (e.angle < 90 ? i.leftPos : i.rightPos) + i.depth,
                                            n && (i.element.material[5].opacity = i.element.material[4].opacity = e.index, i.element.castShadow = e.index > .5),
                                            i.height = e.height,
                                            i.width = e.width,
                                            i.updateAngle(!0)
                                        }
                                        ...
                                        i.currentTween = null,
                                        i.isFlipping = !1,
                                        i.isCover && (i.viewer.leftCover.isFlipping = !1, i.viewer.rightCover.isFlipping = !1),
            ...
            return ke(n, [{
                        ...
                        value: function () {
                            ...
                            if (t !== e.FLIPBOOK_COVER_TYPE.PLAIN) {
                                ...
                                s.closePath(),
                                s.fill(),
                                n && ((i = s.createLinearGradient(l, 0, 7.68, 0)).addColorStop(0, "rgb(127,127,255)"), i.addColorStop(.25, "rgb(255,127,255)"), i.addColorStop(.5, "rgb(0,127,255)"), i.addColorStop(.75, "rgb(127,127,255)"), i.addColorStop(1, "rgb(127,127,255)"), s.fillStyle = i, s.fillRect(l, 0, 7.68, o)),
                                ...
                                h.closePath(),
                                h.fill(),
                                n && ((i = h.createLinearGradient(120.32, 0, 126.08, 0)).addColorStop(0, "rgb(127,127,255)"), i.addColorStop(.25, "rgb(127,127,255)"), i.addColorStop(.5, "rgb(255,127,255)"), i.addColorStop(.75, "rgb(0,127,255)"), i.addColorStop(1, "rgb(127,127,255)"), h.fillStyle = i, h.fillRect(120.32, 0, 5.76, o)),
                        ...
                        value: function () {
                            ...
                            if (r.fillStyle = t, r.fillRect(0, 0, o, o), r.strokeStyle = "rgba(50,50,50," + (n / 2 + .4) + ")", r.strokeRect(.1 * o, .05 * o, o * (this.hasSpiral ? .9 : .85), .9 * o), r.beginPath(), r.strokeStyle = "rgba(50,50,50," + (n / 2 + .3) + ")", r.lineWidth = 2, r.moveTo(0, 0), r.lineTo(.1 * o, .05 * o), r.stroke(), r.beginPath(), r.strokeStyle = "rgba(50,50,50," + (n / 2 + .4) + ")", r.moveTo(0, o), r.lineTo(.1 * o, .95 * o), r.stroke(), r.beginPath(), r.strokeStyle = "rgba(255,255,255,0.3)", r.lineWidth = 4, r.moveTo(0, 0), r.lineTo(0, o), r.moveTo(0, 0), r.lineTo(o, 0), r.stroke(), r.beginPath(), r.strokeStyle = "rgba(50,50,50," + (n / 2 + .3) + ")", r.lineWidth = 4, r.moveTo(0, o), r.lineTo(o, o), r.stroke(), !1 === this.hasSpiral) {
                                ...
                                r.beginPath(), r.strokeStyle = "rgba(50,50,50,0.2)", r.lineWidth = 4, r.moveTo(o, 0), r.lineTo(o, o), r.stroke();
                            ...
                            if (h.fillStyle = t, h.fillRect(0, 0, o, o), h.strokeStyle = "rgba(50,50,50," + (n / 2 + .5) + ")", h.strokeRect(o * (this.hasSpiral ? 0 : .05), .05 * o, o * (this.hasSpiral ? .9 : .85), .9 * o), h.beginPath(), h.strokeStyle = "rgba(50,50,50," + (n / 2 + .3) + ")", h.lineWidth = 2, h.moveTo(o, 0), h.lineTo(.9 * o, .05 * o), h.stroke(), h.beginPath(), h.strokeStyle = "rgba(50,50,50," + (n / 2 + .5) + ")", h.moveTo(o, o), h.lineTo(.9 * o, .95 * o), h.stroke(), h.beginPath(), h.strokeStyle = "rgba(255,255,255,0.3)", h.lineWidth = 4, h.moveTo(0, 0), h.lineTo(o, 0), h.stroke(), h.beginPath(), h.strokeStyle = "rgba(50,50,50," + (n / 2 + .3) + ")", h.lineWidth = 4, h.moveTo(o, 0), h.lineTo(o, o), h.moveTo(0, o), h.lineTo(o, o), h.stroke(), !1 === this.hasSpiral) {
                                ...
                                h.beginPath(), h.strokeStyle = "rgba(255,255,255,0.2)", h.lineWidth = 4, h.moveTo(0, 0), h.lineTo(0, o), h.stroke();
                        ...
                        value: function () {
                            ...
                            !0 !== this.has3DCover && (this.coverExtraWidth = 0, this.coverExtraHeight = 0),
                            e.zoomViewer.resize(),
                        ...
                        value: function (e, t, i, n) {
                            ...
                            void 0 !== n && (n.target = new THREE.Vector3(0, 0, 0), n.maxDistance = 2 * f)
                        }
                    }, {
                        ...
                        value: function () {
                            ...
                            if (h) {
                                ...
                                !0 !== e.leftCover.isFlipping && (e.leftCover.element.position.z = v ? e.midPosition + e.coverDepth : p + e.coverDepth / 2, e.leftCover.element.position.z = Math.max(e.leftCover.element.position.z, .05 * -e.refSize), e.leftCover.element.position.x = 0, e.leftSheets.sheetAngle = e.leftCover.sheetAngle = v ? 180 : 0, e.leftSheets.curveAngle = e.leftCover.curveAngle = v ? 180 : 0, !0 !== e.rightCover.isFlipping && (e.leftCover.height = y, e.leftCover.width = e.leftCover.sheetAngle < 90 ? this.leftSheetWidth : this.rightSheetWidth, this.isClosedPage() || (e.leftCover.width += this.coverExtraWidth, e.leftCover.height += this.coverExtraHeight)), e.leftSheets.updateAngle(), e.leftCover.updateAngle()),
                        ...
                        value: function (t) {
                            ...
                            !1 === o.isFlipping && (t.needsFlip ? (o.isFlipping = !0, o.isCover && 0 === t.sheetNumber && (n.isRTL ? n.rightCover.isFlipping = !0 : n.leftCover.isFlipping = !0), o.isCover && n.totalSheets - t.sheetNumber == 1 && (n.isRTL ? n.leftCover.isFlipping = !0 : n.rightCover.isFlipping = !0), o.element.position.z = Math.max(r < 90 ? o.leftPos : o.rightPos, n.midPosition) + n.sheetDepth, o.flexibility = r < 90 ? o.leftFlexibility : o.rightFlexibility, o.flip(r, i)) : (o.skipFlip = !1, o.sheetAngle = o.curveAngle = i, o.flexibility = i < 90 ? o.leftFlexibility : o.rightFlexibility, o.element.position.z = i < 90 ? o.leftPos : o.rightPos, o.side = o.targetSide, o.height = i < 90 ? this.leftSheetHeight : this.rightSheetHeight, o.width = i < 90 ? this.leftSheetWidth : this.rightSheetWidth), o.updateAngle(), this.app.renderRequestStatus = Ie.REQUEST_STATUS.ON),
                        ...
                        value: function () {
                            ...
                            n !== e.centerEnd && (e.centerTween && e.centerTween.stop && e.centerTween.stop(), e.onCenterStartAnimation(this), e.centerTween = new TWEEN.Tween({
                                    x: i
                                }).delay(0).to({
                                    x: n
                                        ...
                                        })).easing(TWEEN.Easing.Cubic.InOut).start(), this.updatePendingStatusClass(), e.skipCenterAnimation = !1, e.centerEnd = n),
                        ...
                        value: function (e) {
                            ...
                            i,
                            n = null;
                            0 === e.pageNumber || this.isBooklet && 1 === e.pageNumber ? (n = this.isRTL ? this.rightCover : this.leftCover, t = this.isRTL ? 1 : -1) : e.pageNumber === this.totalSheets - 1 && (n = this.isRTL ? this.leftCover : this.rightCover, t = this.isRTL ? -1 : 1),
                            null !== n && (i = n.depth + e.depth + 1, n.sheetAngle = e.sheetAngle, n.curveAngle = e.curveAngle, this.rightCover.height = this.leftCover.height = e.height + this.coverExtraHeight, this.rightCover.width = this.leftCover.width = e.width + this.coverExtraWidth, n.flexibility = e.flexibility, this.rightCover.updateAngle(), this.leftCover.updateAngle(), n.element.position.x = e.element.position.x + t * Math.sin(e.sheetAngle * Math.PI / 180) * i, n.element.position.z = e.element.position.z + t * Math.cos(e.sheetAngle * Math.PI / 180) * i)
                        }
                    }, {
                        key: "pagesReady",
                        value: function () {
                            if (!this.isAnimating() && !0 === this.refreshRequested) {
                                if (!1 === this.app.options.flipbookFitPages) {
                                    ...
                                    if (this.isClosedPage()) {
                                        ...
                                        this.leftCover.height = this.rightCover.height = this.coverExtraHeight + Math.max(this.leftSheetHeight, this.rightSheetHeight), this.leftCover.width = this.coverExtraWidth + this.leftSheetWidth, this.rightCover.width = this.coverExtraWidth + this.rightSheetWidth;
                        ...
                        value: function (e) {
                            if ((e = _e.fixMouseEvent(e)).touches || 0 === e.button)
                                if (null == e.touches || 2 != e.touches.length) {
                                    ...
                                    t.lastPosX = i.x,
                                    t.lastPosY = i.y,
                                    i.isInsideDragZone && !1 !== t.drag3D ? (t.dragSheet = i.sheet, t.drag = i.sheet.sheetAngle < 90 ? Ie.TURN_DIRECTION.LEFT : Ie.TURN_DIRECTION.RIGHT) : t.canSwipe = !0
                                } else
                                    this.pinchDown(e)
                        }
                    }, {
            ...
            if (!0 !== Fe.initialized) {
                ...
                Fe = {
                    ...
                    clearChild: function (e) {
                        ...
                        if (e.parent.remove(e), e = _e.disposeObject(e), null != i) {
                            if (null == i.length)
                                i.map && (t = i.map, i.dispose(), t.dispose()), i.bumpMap && (t = i.bumpMap, i.dispose(), t.dispose()), i.normalMap && (t = i.normalMap, i.dispose(), t.dispose());
                            else
                                for (var n = 0; n < i.length; n++)
                                    i[n] && (i[n].map && (t = i[n].map, i[n].dispose(), t.dispose()), i[n].bumpMap && (t = i[n].bumpMap, i[n].dispose(), t.dispose()), i[n].normalMap && (t = i[n].normalMap, i[n].dispose(), t.dispose())), i[n] = null;
                            i = null,
                            t = null
                        }
                    },
                    loadImage: function (t, i, n, o, a) {
                        ...
                        return "CANVAS" === i.nodeName || "IMG" === i.nodeName ? ((s = new e.Texture(i)).needsUpdate = !0, Fe.loadTexture(s, t, o, n), "function" == typeof a && a(t, s)) : "blank" !== i ? (s = null == i ? null : Fe.textureLoader.load(i, (function (e) {
                                    ...
                                    }))) && (s.mapping = e.UVMapping) : (Fe.loadTexture(null, t, o, n), "function" == typeof a && a(t, s)),
                        0
                    },
                    loadTexture: function (t, i, n, o) {
                        if (t) {
                            ...
                            t.needsUpdate = !0,
                            null != i.textureRotation && (t.rotation = e.MathUtils.degToRad(i.textureRotation), t.center = i.textureCenter)
                        }
                        null !== t && "map" === n && (t.anisotropy = 0, Fe.defaults.anisotropy > 0 && (t.anisotropy = Fe.defaults.anisotropy), !0 === e.skipPowerOfTwo && (t.minFilter = e.LinearFilter, t.magFilter = e.LinearFilter), t.name = (new Date).toTimeString()),
                ...
                n = function (t) {
                    ...
                    function o(t) {
                        ...
                        !1 !== t.castShadow && (s.castShadow = !0, s.shadow.camera.near = 200, s.shadow.camera.far = 2e3, s.shadow.camera.top = 1350, s.shadow.camera.bottom = -1350, s.shadow.camera.left = -1350, s.shadow.camera.right = 1350, s.shadow.radius = 2, s.shadow.mapSize.width = 1024, s.shadow.mapSize.height = 1024),
                        r.add(s),
                        r.animateCount = 0,
                        r.renderCount = 0,
                ...
                e.CSS3DRenderer = function () {
                    ...
                    c = function t(i, n) {
                        if (i instanceof e.CSS3DObject) {
                            ...
                            var s = i.element,
                            u = r.objects[i.id];
                            void 0 !== u && u === o || (s.style.WebkitTransform = o, s.style.MozTransform = o, s.style.oTransform = o, s.style.transform = o, r.objects[i.id] = o),
                    ...
                    this.render = function (t, a) {
                        ...
                        r.camera.fov !== u && (s.style.WebkitPerspective = u + "px", s.style.MozPerspective = u + "px", s.style.oPerspective = u + "px", s.style.perspective = u + "px", r.camera.fov = u),
                        t.updateMatrixWorld(),
                        ...
                        r.camera.style !== p && (l.style.WebkitTransform = p, l.style.MozTransform = p, l.style.oTransform = p, l.style.transform = p, r.camera.style = p),
                        c(t, a)
                    }
                }
            }
        ...
        y.prototype.pinchMove = function (t) {
            if (null != t.touches && 2 == t.touches.length && null != this.startTouches) {
                ...
                this.app.viewer._pinchZoomLastScale != this.app.viewer.pinchZoomUpdateScale && (this.app.viewer.pinchZoomRequestStatus = e.REQUEST_STATUS.ON, this.app.viewer._pinchZoomLastScale = this.app.viewer.pinchZoomUpdateScale),
        ...
        Xe = Ue((function t(i, n) {
                    ...
                    "flat3D" === i.is3D ? (i.flexibility = 0, new Ke(i, n)) : "calendar3D" === i.is3D ? new Qe(i, n) : Ze.isTrue(i.is3D) ? new Me(i, n) : new ue(i, n)
                }));
        function Ye(e, t) {
            ...
            return ot(t, [{
                        ...
                        value: function (e) {
                            ...
                            t.then((function (t) {
                                    at.log("Started:", t),
                                    e = t,
                                    t instanceof Array && (n.pdfApp.requestDestRefKey = t[0].num + " " + t[0].gen + " R", o(t[0]))
                                }))
                        }
                    }, {
                        ...
                        value: function (t) {
                            if ("" !== t && null != t && "null" !== t) {
                                ...
                                if (isNaN(Math.floor(t))) {
                                    if ("string" == typeof t && (i = parseInt(t.replace("#", ""), 10), isNaN(i)))
        ...
        lt = function (t) {
            ...
            function o(t, a) {
                ...
                function h(t) {
                    ...
                    i.hostname !== window.location.hostname && !0 === e.loadCorsPdfjsWorker ? (l.updateInfo(l.options.text.loading + " PDF Worker CORS ..."), jQuery.ajax({
            ...
            return ot(o, [{
                            ...
                            i.pdfDocument.getPage(a).then((function (r) {
                                    ...
                                    r.render(l).promise.then((function () {
                                            if (t.applyTexture(l.canvas, e), !0 === t.options.cleanupAfterRender) {
                                                ...
                                                i.requestedPages.indexOf(s) > -1 && (i.requestedPages = i.requestedPages.replace(s, ""), -1 == i.requestedPages.indexOf("[" + a + "|") ? (at.log("CleanUp Passed for (" + n + ") actual " + a), i.pagesToClean.push(r), i.pagesToClean.length > 0 && i.cleanUpPages()) : at.log("CleanUp Cancelled waiting for (" + n + ") actual " + a + " : " + i.requestedPages))
                                            }
                                            l = null,
                        ...
                        value: function (e) {
                            ...
                            i.searchPage(t).then((function (n) {
                                    ...
                                    i.app.viewer.isActivePage(t) && (i.processTextContent(t, i.app.viewer.getTextElement(t, !0)), i.app.ui.update()),
                                    i._search(e, t + 1)
                        ...
                        value: function (e, t) {
                            ...
                            if (null == (n = this).textContentJoinedSearch[t] || i) {
                                ...
                                for (var l = 0; l < e.items.length; l++)
                                    o = e.items[l], n.textContentSearch[t].push(!0 === o.hasEOL ? o.str + " " : o.str), n.textContent[t].push(o.str + " "), r += s = (o.str.length || 0) + (!0 === o.hasEOL ? 1 : 0), n.textOffsetSearch[t].push({
                                        length: s,
                                        offset: r - s
        ...
        bt = function () {
            function e(t) {
                ...
                for (var i = 0; i < t.length; i++)
                    this.source[i] = mt.httpsCorrection(t[i].toString()), this.pages.push(new yt({
                            src: this.source[i]
                        }))
            }
            return vt(e, [{
            ...
            return xt(t, [{
                        ...
                        value: function () {
                            ...
                            o.thumbnail.on("click", (function () {
                                    ...
                                    e.hasClass("df-active") && (e.siblings(".df-active").trigger("click"), n.thumbRequestStatus = Ot.ON),
                                    t.update(),
                                    !1 === n.options.sideMenuOverlay && n.resizeRequestStart()
                                })).addClass("df-sidemenu-trigger"),
                            n.hasOutline() && (this.outline = o.outline = Et.createBtn("outline", r.outline, a.toggleOutline), o.outline.on("click", (function () {
                                        var e = kt(this);
                            ...
                            !0 === n.options.showSearchControl && !0 !== Et.isMobile && "string" == typeof n.options.source && (o.search = Et.createBtn("search", r.search, a.search), o.search.on("click", (function () {
                                        var e = kt(this);
                                        if (null == n.searchContainer && n.initSearch(), n.searchContainer) {
                                            var i = n.searchContainer;
                                            e.toggleClass("df-active"),
                                            i.toggleClass("df-sidemenu-visible"),
                                            e.hasClass("df-active") && (e.siblings(".df-active").trigger("click"), n.searchBox.focus()),
                                            t.update(),
                                            !1 === n.options.sideMenuOverlay && n.resizeRequestStart()
                                        }
                                    })).addClass("df-sidemenu-trigger"));
        ...
        At = function () {
            ...
            return xt(e, [{
                        ...
                        value: function (e, t) {
                            ...
                            if (!0 === t.custom)
                                e.href = i.getCustomDestinationHash(t.dest), e.onclick = function () {
                            ...
                            if (0 === t.thumblist.container.getElementsByClassName("df-thumb-requested").length) {
                                ...
                                for (var s = 0; s < r.length; s++) {
                                    ...
                                    if (void 0 !== l && !1 === l.classList.contains("df-thumb-loaded") && !1 === l.classList.contains("df-thumb-requested"))
                                        return l.classList.add("df-thumb-requested"), Et.log("Thumb Requested for " + r[s]), t.provider.processPage({
                                            pageNumber: r[s],
        ...
        e.openLightBox = function (t) {
            ...
            void 0 !== e.activeLightBox.app && null !== e.activeLightBox.app && !0 !== e.activeLightBox.app.closeRequested && e.openLocalFileInput != t || (e.activeLightBox.app = Et.disposeObject(e.activeLightBox.app), null === e.activeLightBox.app && e.activeLightBox.show((function () {
        ...
        e.checkBrowserURLforPDF = function () {
            ...
            if (!Et.isIEUnsupported) {
                ...
                return i && (i = unescape(i), t && e.openURL(i)),
                i
            }
        },
        ...
        e.openURL = function (t) {
            Dt(),
            t && (e.openFileOptions.source = t, e.openFileOptions.pdfParameters = null),
        ...
        jt = function () {
            ...
            n = [{
                    ...
                    value: function () {
                        ...
                        i.initInfo(),
                        null != t.source && 0 !== t.source.length || null != t.pdfParameters ? Ut.isIEUnsupported ? (i.updateInfo("Your browser (Internet Explorer) is out of date! <br><a href='https://browsehappy.com/'>Upgrade to a new browser.</a>", "df-old-browser"), void i.container.removeClass("df-loading").addClass("df-error")) : (i.commentPopup = Bt('<div class="df-comment-popup">').appendTo(i.container), i.viewer = new i.viewerType(t, this), i.sideMenu = new _t({
                    ...
                    value: function () {
                        var t = this.options;
                        if (void 0 !== window[e.locationVar]) {
                            if (t.pdfjsSrc = window[e.locationVar] + "pdf.min.js", // Remove folders for Shopify compatibility

                                t.threejsSrc = window[e.locationVar] + "three.min.js", // Remove folders for Shopify compatibility
                                t.pdfjsWorkerSrc = window[e.locationVar] + "pdf.worker.min.js", // Remove folders for Shopify compatibility
                               ...
                               t.cMapUrl = "https://raw.githubusercontent.com/Paulenski205/shopify-dflip-accessories/main/cmaps/",
                                void 0 !== t.pdfVersion) {
                                var i = "";
                                "latest" == t.pdfVersion || "beta" == t.pdfVersion ? i = "latest" : "stable" == t.pdfVersion && (i = "stable"),
                                ("latest" == t.pdfVersion || "default" == t.pdfVersion) && (Array.prototype.at, void 0 === Array.prototype.at && (i = "stable", console.log("Proper Support for Latest version PDF.js 3.7 not available. Switching to PDF.js 2.5!"))),
                                "default" !== i && "" !== i && (t.pdfjsSrc = window[e.locationVar] + "pdf.min.js", // Remove folders for Shopify compatibility
                                    t.pdfjsWorkerSrc = window[e.locationVar] + "pdf.worker.min.js")
                            }
                        } // Remove folders for Shopify compatibility
                        else
                    ...
                    value: function () {
                        ...
                        !0 === this.options.dataElement.hasClass("df-hash-focused") && (Ut.focusHash(this.options.dataElement), this.options.dataElement.removeClass("df-hash-focused")),
                    ...
                    value: function () {
                        ...
                        if (e.checkRequestQueue && requestAnimationFrame((function () {
                            ...
                            if ("ready" != e.state)
                                return "loading" === e.state && !0 === this.isDocumentReady && !0 === this.isViewerPrepared && !0 === this.isExternalReady && (e.state = "finalizing", this.finalizeComponents()), void("finalizing" === e.state && (e.state = "ready", e.finalize()));
                            e.container && e.container[0] && e._offsetParent !== e.container[0].offsetParent && (e._offsetParent = e.container[0].offsetParent, null !== e._offsetParent && (e.resize(), e.resizeRequestStatus = Ht.OFF), Ut.log("Visibility Resize Detected")),
                            (null !== e._offsetParent || e.isFullscreen) && (TWEEN.getAll().length > 0 && (TWEEN.update(), e.renderRequestStatus = Ht.ON), e.resizeRequestStatus === Ht.ON ? (e.resizeRequestStatus = Ht.OFF, e.resize()) : e.resizeRequestStatus === Ht.COUNT && (e.resizeRequestCount++, e.resizeRequestCount > 10 && (e.resizeRequestCount = 0, e.resizeRequestStatus = Ht.ON)), e.refreshRequestStatus === Ht.ON ? (e.refreshRequestStatus = Ht.OFF, e.pendingResize = !1, e.viewer.refresh(), this.container.removeClass("df-pendingresize")) : e.refreshRequestStatus === Ht.COUNT && (e.refreshRequestCount++, e.refreshRequestCount > 3 && (e.refreshRequestCount = 0, e.refreshRequestStatus = Ht.ON)), e.textureRequestStatus === Ht.ON && e.processTextureRequest(), e.thumbRequestStatus === Ht.ON ? e.processThumbRequest() : e.thumbRequestStatus === Ht.COUNT && (e.thumbRequestCount++, e.thumbRequestCount > 3 && (e.thumbRequestCount = 0, e.thumbRequestStatus = Ht.ON)), e.renderRequestStatus === Ht.ON && (e.viewer.render(), e.renderRequestStatus = Ht.OFF), e.provider.checkRequestQueue(), e.viewer.checkRequestQueue())
                        }
                    }
                }, {
                        ...
                        if (o.isAnimating())
                            ...
                            for (var u = 0; u < r.length; u++) {
                                ...
                                if (h > 0 && h <= n.pageCount && ((t = l ? o.zoomViewer.getPageByNumber(h) : o.getPageByNumber(h)) && (i = o.getTextureSize({
                                                ...
                                                }), s++, n.viewer.getAnnotationElement(h, !0))), s > 0))
                                    break
                            }
                    ...
                    value: function (t, i) {
                        ...
                        if (i.textureTarget === e.TEXTURE_TARGET.THUMB) {
                            ...
                            i.texture = o ? t : t.src, !0 === n.viewer.setPage(i) && (n.provider.processAnnotations(i.pageNumber, n.viewer.getAnnotationElement(i.pageNumber, !0)), n.provider.processTextContent(i.pageNumber, n.viewer.getTextElement(i.pageNumber, !0)))
                    }
                }, {
                    key: "processThumbRequest",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        a.isFullSize || c == a.containerHeight || (a.containerHeight = c, a.stage.innerHeight = c - a.padding.height, a.stage.height = c),
                        a.origin = {
                    ...
                    value: function () {
                        ...
                        t.viewer.handleZoom(),
                        t.viewer.resize(),
                        !1 !== e && (t.pendingZoom ? (this.viewer.refresh(), Ut.log("Pending Zoom updated")) : this.refreshRequestStart(), this.ui.update(), this.renderRequestStatus = Ht.ON, t.zoomChanged = !1, t.pendingZoom = !1, this.executeCallback("afterResize"))
                    }
                }, {
                    key: "hasOutline",
                    value: function () {
                    ...
                    value: function (e) {
                        ...
                        null !== t.viewer && !1 !== t.viewer.validatePageChange(e) && (this.executeCallback("beforePageChanged"), t.requestDestRefKey = void 0, t.container.removeClass("df-fetch-pdf"), t.oldPageNumber = t.currentPageNumber, t.currentPageNumber = e, t.thumbRequestStatus = Ht.ON, t.viewer.gotoPageCallBack && t.viewer.gotoPageCallBack(), t.ui.update(), 1 == this.autoPlay && this.setAutoPlay(this.autoPlay), !0 === this.hashNavigationEnabled && this.getURLHash(), this.executeCallback("onPageChanged"))
                    }
                }, {
                    key: "gotoPageLabel",
                    value: function (e) {
        ...
        function Zt(e, t, i) {
            for (var n = [], o = !1, a = 0, r = 0, s = 0, l = void 0, u = 0, h = 0; h < e.length; h++) {
                ...
                if (s = (r = t[h].offset) + t[h].length, 0 == o)
                    l = null === (p = i[u]) || void 0 === p ? void 0 : p.index, a = null === (c = i[u]) || void 0 === c ? void 0 : c.length;
                for (; l >= r && l < s; ) {
                    var f,
                    g;
                    if (d.searchHits || (d.searchHits = []), d.searchHits.push({
                            ...
                            length: a,
                            text: i[u].text
                        }), 1 == d.searchHits.length && n.push(d), l + a > s)
                        a = l + a - s, l = s, o = !0;
                    else
                        o = !1, l = null === (f = i[++u]) || void 0 === f ? void 0 : f.index, a = null === (g = i[u]) || void 0 === g ? void 0 : g.length
                }
            }
            return n
        }
        e.prepareOptions = function (t) {
            ...
            "function" != typeof e.viewers[r.viewerType] ? (console.warn("Invalid Viewer Type! " + r.viewerType + " | Using default Viewer!"), r.viewerType = e.viewers.default) : r.viewerType = e.viewers[r.viewerType],
                    ...
                    i.pdfDocument.getPage(a).then((function (r) {
                            ...
                            r.getTextContent().then((function (r) {
                                    ...
                                    if (null == c && null != i.textOffsetSearch[a] && d && d.length > 0 && (c = Zt(r.items, i.textOffsetSearch[a], d), i.searchHitItemsCache[a] = c), h && h.length > 0) {
                                        ...
                                        0 == v.length && (v = jQuery('<div class="df-auto-link-content">'), jQuery(t).parent().prepend(v)),
                                        v.html(""),
                                        r.items = h;
                                    ...
                                    if (c && c.length > 0) {
                                        ...
                                        m._textDivs.forEach((function (e) {
                                                ...
                                                a = 0;
                                                for (a = 0; a < t.searchHits.length; a++)
                                                    i += t.str.substring(n, t.searchHits[a].start), n = t.searchHits[a].start, o = t.searchHits[a].length, i += '<span class="df-search-highlight">' + t.str.substring(n, n + o) + "</span>", n += o;
                                                i += t.str.substring(n, t.str.length),
                                                b++,
                                                e.innerHTML = i,
                ...
                i.pdfDocument.getPage(o).then((function (a) {
                        ...
                        a.getAnnotations().then((function (s) {
                                if (null !== n.options && null !== n.viewer && 0 != s.length) {
                                    ...
                                    if (n.options.annotationClass && "" !== n.options.annotationClass && jQuery(t).find(" > section").addClass(n.options.annotationClass), null == i.PDFLinkItemsCache[o])
        ...
        Qt.parseLinks = function (e) {
            ...
            if (null != e && e.length > 0)
                for (var i = 0; i < e.length; i++)
                    null != (t = e[i]) && null != t[0] && null == t[0].dest && (t = Qt.ConvertPageLinks.apply(this, t), e[i] = t);
            return e
        },
        ...
        Kt(document).ready((function () {
                ...
                e.on("click", ".df-element[data-df-lightbox],.df-element[data-lightbox]", (function (e) {
                        ...
                        if (!t || !t.hasClass("df-edit-link")) {
                            ...
                            a && (e.preventDefault(), e.stopPropagation(), Qt.openLightBox(i))
                        }
                    })),
